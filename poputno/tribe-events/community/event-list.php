...
wp_redirect(get_bloginfo('url') . '/cabinet');
// List "Add New" Button
do_action('tribe_ce_before_event_list_top_buttons'); ?>

<div id="add-new"><a href="<?php echo tribe_community_events_add_event_link(); ?>"
                     class="button"><?php echo apply_filters('tribe_ce_add_event_button_text', __('Add New', 'tribe-events-community')); ?></a>
</div>
...
<div class="table-menu-wrapper">
    ...
    if ($events->have_posts()) {
        ?>
        <a href="#"
           class="table-menu-btn button"><?php echo apply_filters('tribe_ce_event_list_display_button_text', __('Display', 'tribe-events-community')); ?></a><!-- table-menu-btn -->
    <?php } ?>
