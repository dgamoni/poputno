!function()
{
	...
	pktObj.l = function()
	{
		...
		for(i=0; i<linksToReplace.length; i++)
		{
			...
			src = 'http://ain.ua/wp-content/themes/ain5v/core/modules/custom_soc_buttons/buttons.php?label='+label+'&count='+count+(align?'&align='+align:'')+'&v='+v+'&url='+encodeURIComponent(saveurl)+'&title='+encodeURIComponent(savetitle)+'&src='+encodeURIComponent(savesrc)+'&r='+Math.random();
