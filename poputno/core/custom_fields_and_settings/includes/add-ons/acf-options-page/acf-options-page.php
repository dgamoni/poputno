...
class acf_options_page_plugin
{
    ...
    */
    ...
    function __construct()
    {
        // vars
        $this->settings = array(
            'title' => __('Настройки темы', 'acf'), // title / menu name ('Site Options')
    ...
    */
    ...
    function admin_menu()
    {
        ...
        if (OPTIONS_ICON)
            ...
            $img = '';
        // Parent
        $parent_page = add_menu_page($parent_title, $parent_menu, $this->settings['capability'], $parent_slug, array($this, 'html'), $img, 43);
